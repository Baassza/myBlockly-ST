        ...
        "args0": [
            {
                "type": "input_value",
                "name": "VALUE",
                "check": [Blockly.ST.STRING_TYPE, 'Array']
            }
        ],
...
Blockly.Blocks['text_getSubstring'] = {
    ...
    init: function () {
        ...
        this.setOutput(true, Blockly.ST.STRING_TYPE);
...
Blockly.Blocks['text_prompt_ext'] = {
    ...
    updateType_: function (newOp) {
        this.outputConnection.setCheck(newOp === 'NUMBER' ? Blockly.ST.ANY_NUM_TYPE : Blockly.ST.STRING_TYPE);
    },
    /**
